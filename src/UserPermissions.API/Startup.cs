...
namespace UserPermissions.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAutoMapper(typeof(IUserPermissionsRepository).Assembly);
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "User Permissions API", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "User Permissions API V1");
